...
export default function Task5({ onSuccess }) {
  ...
  const [input, setInput] = useState("4 10 5 7 8");
...
`);
      ...
      if (hasFor && resultOutput.includes(correctAnswer)) {
        setIsCorrect(true);
      } else {
        setIsCorrect(false);
      }
  ...
  return (
    <div style={{ backgroundColor: "#000", color: "#FFD700", minHeight: "100vh", padding: "2rem" }}>
      ...
      <p style={{ color: "#ccc", fontSize: "1.2rem", marginBottom: "1rem" }}>
        👦 Айдос бірнеше сан енгізу арқылы олардың қосындысын табатын бағдарлама жазғысы келеді.
        <br />Алдымен <strong>N</strong> саны енгізіледі, содан кейін дәл <strong>N</strong> бүтін сан енгізіледі.
        <br />Сол сандардың қосындысын есептейтін <strong>for</strong> циклін қолданып бағдарлама жаз.
      </p>
