...
export default function Task4({ onSuccess }) {
  ...
  const [input, setInput] = useState("15 5");
...
`);
      ...
      const correct =
        ...
        resultOutput.replaceAll("\n", " ").includes("15") &&
        resultOutput.includes("5");
  ...
  return (
    <div style={{ backgroundColor: "#000", color: "#FFD700", minHeight: "100vh", padding: "2rem" }}>
      ...
      <p style={{ color: "#ccc", fontSize: "1.2rem", marginBottom: "1rem" }}>
        🧮 A және B бүтін сандары берілген. A &gt; B шартын сақтай отырып, A-дан B-ге дейінгі барлық <strong>тақ</strong> сандарды <strong>кемімелі</strong> тәртіпте шығаратын бағдарлама жаз. <br /> <strong>if</strong> операторын қолдануға болмайды.
      </p>

      <div style={{ backgroundColor: "#111", color: "#FFD700", padding: "1rem", borderRadius: "10px", fontFamily: "monospace", marginBottom: "1rem" }}>
        <pre>{`Кіріс: 15 5\nШығыс: 15 13 11 9 7 5`}</pre>
      </div>
