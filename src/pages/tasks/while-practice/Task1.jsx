...
setOutput(resultOutput);
    ...
    const hasExpectedPattern = resultOutput.includes("* * * * *");

    if (hasWhile && hasPrint && hasExpectedPattern) {
      setIsCorrect(true);
    } else {
      setIsCorrect(false);
    }
  ...
  return (
    <div style={{ backgroundColor: "#000", color: "#FFD700", minHeight: "100vh", padding: "2rem" }}>
      ...
      <p style={{ color: "#ccc", fontSize: "1.2rem", marginBottom: "1rem" }}>
        👦 Айдос сахнаны безендіру үшін жұлдызшалардан пирамида шығаратын бағдарлама жазғысы келеді.
        Сен <strong>while</strong> циклін қолданып, төмендегідей үшбұрыш үлгісін шығаратын Python кодын жаз:
      </p>
...
* * * * *`}
      ...
      {isCorrect && (
        <div style={{ marginTop: "2rem" }}>
          ...
          <button
            onClick={() => navigate("/grade8/while-practice/2")}
            style={{
